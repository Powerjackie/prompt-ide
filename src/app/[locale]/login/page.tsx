...
export default function LoginPage() {
  ...
  return (
    <div className="app-panel w-full overflow-hidden border-white/10 bg-[linear-gradient(135deg,rgba(14,18,27,0.96),rgba(11,14,23,0.92))] shadow-[0_32px_90px_-48px_rgba(15,23,42,0.7)] dark:border-white/10">
      <div className="grid gap-0 lg:grid-cols-[minmax(0,1.18fr)_minmax(360px,0.82fr)]">
        <div className="order-2 relative overflow-hidden px-5 py-5 sm:px-8 sm:py-7 lg:order-1 lg:px-12 lg:py-12">
          ...
          <div className="relative space-y-5 sm:space-y-7">
            <div className="page-header border-none bg-transparent p-0 shadow-none">
              ...
              <div className="space-y-3">
                <h1 className="page-header__title max-w-[13ch] text-3xl text-white sm:text-5xl">
                  Prompt IDE
                </h1>
                <p className="page-header__description max-w-[54ch] text-sm text-white/70 sm:text-lg">
                  {t("description")}
                </p>
              </div>
            </div>
            ...
            <div className="hidden gap-3 text-sm text-white/62 sm:grid sm:grid-cols-3">
        ...
        <div className="order-1 flex items-start justify-center px-4 py-4 sm:px-8 sm:py-7 lg:order-2 lg:items-center lg:px-10 lg:py-12">
          <Card className="w-full max-w-none border-white/10 bg-[linear-gradient(180deg,rgba(18,24,37,0.96),rgba(14,19,31,0.94))] text-white shadow-[0_30px_90px_-40px_rgba(17,24,39,0.75)] sm:max-w-[28rem]">
