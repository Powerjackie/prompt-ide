    ...
    <div className={cn("rounded-[1.75rem] border border-border/70 bg-muted/20 shadow-[inset_0_1px_0_rgba(255,255,255,0.2)] dark:border-primary/12 dark:bg-[linear-gradient(180deg,rgba(9,12,20,0.78),rgba(17,22,37,0.92))] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.03),0_24px_58px_-36px_rgba(79,246,255,0.22)]", className)}>
      ...
      <div className="relative">
        ...
        <Textarea
          ...
          className="relative z-10 min-h-[420px] resize-y border-0 bg-transparent px-4 py-4 font-mono text-sm leading-7 shadow-none focus-visible:ring-0 dark:text-slate-100 dark:caret-primary"
          spellCheck={false}
        />
      </div>
      ...
      <div className="flex items-center justify-between gap-3 border-t border-border/60 px-4 py-3 text-xs text-muted-foreground">
        ...
        <span>{canvasPlaceholderHint}</span>
      </div>
    </div>
  )
}
